...
> Dev chainable map/filter/reduce for iterables

[![PyPI version](https://badge.fury.io/py/dev-map-filter.svg)](https://pypi.org/project/dev-map-filter/)
...
from dev_map_filter import batch
